...
def myNetwork():
    ...
    net.addLink(s1, h2, cls=TCLink, bw=bw)
    net.addLink(h3, s2, cls=TCLink, bw=bw)
    net.addLink(h4, s2, cls=TCLink, bw=bw)
    net.addLink(h5, s3, cls=TCLink, bw=bw)
    net.addLink(h6, s3, cls=TCLink, bw=bw)
    net.addLink(h7, s4, cls=TCLink, bw=bw)
    net.addLink(h8, s4, cls=TCLink, bw=bw)
    net.addLink(h9, s5, cls=TCLink, bw=bw)
    net.addLink(h10, s5, cls=TCLink, bw=bw)
    net.addLink(h11, s6, cls=TCLink, bw=bw)
    net.addLink(h12, s6, cls=TCLink, bw=bw)
    net.addLink(h13, s7, cls=TCLink, bw=bw)
    net.addLink(h14, s7, cls=TCLink, bw=bw)
    net.addLink(h15, s8, cls=TCLink, bw=bw)
    net.addLink(h16, s8, cls=TCLink, bw=bw)
    net.addLink(s7, s12, cls=TCLink, bw=bw)
    net.addLink(s12, s8, cls=TCLink, bw=bw)
    net.addLink(s5, s11, cls=TCLink, bw=bw)
    net.addLink(s11, s6, cls=TCLink, bw=bw)
    net.addLink(s3, s10, cls=TCLink, bw=bw)
    net.addLink(s10, s4, cls=TCLink, bw=bw)
    net.addLink(s1, s9, cls=TCLink, bw=bw)
    net.addLink(s9, s2, cls=TCLink, bw=bw)
    net.addLink(s9, s13, cls=TCLink, bw=bw)
    net.addLink(s13, s10, cls=TCLink, bw=bw)
    net.addLink(s11, s14, cls=TCLink, bw=bw)
    net.addLink(s14, s12, cls=TCLink, bw=bw)
    net.addLink(s13, s15, cls=TCLink, bw=bw)
    net.addLink(s15, s14, cls=TCLink, bw=bw)
    net.addLink(h17, s15, cls=TCLink, bw=bw)
    net.addLink(s1, s2, cls=TCLink, bw=bw)
    net.addLink(s3, s4, cls=TCLink, bw=bw)
    net.addLink(s5, s6, cls=TCLink, bw=bw)
    net.addLink(s7, s8, cls=TCLink, bw=bw)
    net.addLink(s11, s12, cls=TCLink, bw=bw)
    net.addLink(s9, s10, cls=TCLink, bw=bw)
    net.addLink(s13, s14, cls=TCLink, bw=bw)
